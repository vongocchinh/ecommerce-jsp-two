...
<body>
    <%
         ...
         if(request.getParameter("brand")!=null){
          ...
          category=categoryGet.getCategory(Integer.parseInt(category_1));
          ...
          for(Product product:productGet.getRanDomtoanbo()) {%>
                            <div class="col-md-3 col-sm-6" style="border-color: #EEEEEE;border-style: solid;border-width: 0.5px">
                                <div class="single-product">
                                    ...
                                    <h2 style="padding-left: ;font-size: 18px">
