...
<html lang="en">
 ...
 <link rel="icon" type="image/png" href="${root}/img/favicon.ico"/>
    ...
    <title>may anh,may anh,điện thoại smartphone giá rẻ uy tín hổ trợ mọi mặt hàng...</title>
 ...
 <link rel="stylesheet" href="css/css_2.css">
  ...
  <body>
    ...
    Category category=new Category();
      ...
      String category_id_1="-77877681";
      String brand_id_1="12";
     ...
     for(Product product3:productGet.getListProductByCategory(Integer.parseInt(category_id_1))) {%>
