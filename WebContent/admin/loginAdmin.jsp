...
<link rel="icon" type="image/png" href="${root}/login/images1/icons/favicon.ico"/>
<link rel="stylesheet" type="text/css" href="${root}/login/css1/util.css">
	<link rel="stylesheet" type="text/css" href="${root}/login/css1/main.css">
</head>
<body>
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="${root}/AdminUserServlet" method="post" class="login100-form validate-form">
